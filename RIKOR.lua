...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://DEVRIKOR.ml/amir00/captcha.php?c='..captcha..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end 
--------------------------------------------------------------------------------------------------------------
...
local url,res = https.request('https://DEVRIKOR.ml/apiRIKOR/RIKOR.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
...
st = https.request('https://DEVRIKOR.ml/Imagelnfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://DEVRIKOR.ml/Imagelnfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
zh = https.request('https://DEVRIKOR.ml/amirZhfa/RIKOR.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*┄─━━━ ᎡᎬ ━━━━─┄*ٴ⌯∫○ٴ \n"
i = 0
...
gk = https.request('https://DEVRIKOR.ml/amirBrg/RIKOR.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://DEVRIKOR.ml/amirOmr/RIKOR.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://DEVRIKOR.ml/amirVois/RIKOR.php')
if res == 200 then
