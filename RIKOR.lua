...
SUDO = SUDO
sudo_users = {SUDO,1362789822,1700918281}   
print([[
...
io.popen("cd library && wget https://raw.githubusercontent.com/RIKORTEAM/RIKOR/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/RIKORTEAM/Files_RIKOR/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevRIKORW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRIKORW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRIKORW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRIKORW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRIKORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRIKORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRIKORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1362789822) then  
var = true  
elseif tonumber(user_id) == tonumber(1700918281) then
var = true  
...
local UserName = (data.username_ or "lll_n_lll1")
...
RIKOR_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
RIKOR_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
RIKOR_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
RIKOR_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
RIKOR_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
RIKOR_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
RIKOR_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
RIKOR_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
RIKOR_Msg = 'اسطورة المتفاعلين'  
end 
return RIKOR_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@DEVRIKOR")  
...
--------------------------------------------------------------------------------------------------------------
function SourceRIKOR(msg,data) -- بداية العمل الزعيم اليماني
if msg then
...
local list = database:smembers(bot_id.."RIKOR1:List:Filter"..sl)
...
if not DevRIKORW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevRIKORW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,RIKOR_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevRIKORW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevRIKORW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevRIKORW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevRIKORW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevRIKORW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevRIKORW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevRIKORW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevRIKORW(msg) then 
os.execute('rm -rf RIKOR.lua')
os.execute('wget https://raw.githubusercontent.com/RIKORTEAM/RIKOR/main/RIKOR.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس ريكور*\n*⌯︙الاصدار » { 2.8v}*')
dofile('RIKOR.lua')  
end
if text == 'الاصدار ⌯' and DevRIKORW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس ريكور* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevRIKORW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/RIKORTEAM) \n⌯︙[قناه السورس](t.me/lll_n_lll1)')
end
if text == "ضع اسم للبوت ⌯" and DevRIKORW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevRIKORW(msg) then 
...
if text == 'المشتركين ⌯' and DevRIKORW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevRIKORW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevRIKORW(msg) then
...
if text == ("قائمه العام ⌯") and DevRIKORW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevRIKORW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevRIKORW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevRIKORW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevRIKORW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevRIKORW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevRIKORW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevRIKORW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevRIKORW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevRIKORW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..RIKORk..''..RIKOR..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevRIKORW(msg) then
...
usertext = '*\n ⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'lll_n_lll1')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevRIKORW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevRIKORW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevRIKORW(msg) then
...
local RIKOR1_Msg = database:get(bot_id.."RIKOR1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RIKOR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'lll_n_lll1')..') \n ⌯︙'..RIKOR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://RIKOR.ml/amir00/captcha.php?c='..captcha..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end 
--------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------
if RIKOR_Msg and not Special(msg) then  
local RIKOR_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RIKOR_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..RIKOR_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/lll_n_lll1)}\n⌯︙["..RIKOR_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","قحاب","فتال","زنوه","قحبه","ابن القحبه","مخنوث","طرطور","طيزك","طيزختك","ابن حرام","زاني","مخنث","خنيث","ابن زبي","زبي"}
for k,v in pairs(list) do
...
send(msg.chat_id_,0, " *⌯︙عذرا ↫* {["..data.first_name_.."](T.ME/lll_n_lll1)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRIKORW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevRIKORW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevRIKORW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRIKORW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevRIKORW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevRIKORW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevRIKORW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevRIKORW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevRIKORW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."RIKOR:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."RIKOR:blocname"..msg.chat_id_)
...
function DEVRIKOR_name(t1,t2)
if t2.id_ then 
name_RIKOR = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_RIKOR then 
names_RIKOR = database:smembers(bot_id.."RIKOR:blocname"..msg.chat_id_) or ""
if names_RIKOR and names_RIKOR[1] then 
for i=1,#names_RIKOR do 
if name_RIKOR:match("(.*)("..names_RIKOR[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, DEVRIKOR_name)
end
...
database:set(bot_id.."RIKOR:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."RIKOR:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."RIKOR:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."RIKOR:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."RIKOR:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_RIKORa_new(RIKOR1,RIKOR2)
if RIKOR2 and RIKOR2.first_name_ then 
if RIKOR2.first_name_:match("(.*)"..database:get(bot_id.."RIKOR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."RIKOR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local RIKOR_nnn = database:get(bot_id.."RIKOR:nump"..msg.chat_id_) or 5
local RIKOR_nnn2 = database:get(bot_id.."RIKOR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(RIKOR_nnn2) == tonumber(RIKOR_nnn) or tonumber(RIKOR_nnn2) > tonumber(RIKOR_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."RIKOR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..RIKOR2.username_.."](https://t.me/"..(RIKOR2.username_ or "lll_n_lll1")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."RIKOR:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(RIKOR_nnn) - tonumber(RIKOR_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_RIKORa_new)
end
end
...
local RIKORChengName = database:get(bot_id.."RIKOR:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RIKORChengName then 
send(msg.chat_id_, msg.id_, " الاسم الاول احلا ["..RIKORChengName..']')
database:del(bot_id.."RIKOR:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RIKORChengName ~= data.first_name_ then 
local Text = {
  "كان الاسم الاول حلو ",
"ليش غيرت اسمك","خقيت واحدة جديده😹💔",
"هذا الحلو غير اسمه 😉",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."RIKOR:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local RIKORChengUserName = database:get(bot_id.."RIKOR:Cheng:UserName"..data.id_)
if not data.username_ then 
if RIKORChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RIKORChengUserName..']')
database:del(bot_id.."RIKOR:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RIKORChengUserName ~= data.username_ then 
local Text = {
'ليش غيرت معرفك نشروك بقنوات فضايح😂🥺',
"هاها شو غيرت معرفك بس لا هددتك/ك الحب",
"خير شصاب يوزرك الاول 😐🌝",
"غير معرفه الحقو بساع بساع \n هاذه معرفه : @"..data.username_.."",
'ها عار مو كان معرفك \n ليش غيرته ل @'..data.username_..' ',
'ها يولد شو مغير معرفك بيش مشتري يولد', 
"منور معرف جديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."RIKOR:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RIKORChengPhoto = database:get(bot_id.."RIKOR:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RIKORChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."RIKOR:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RIKORChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ليش غيرت صورتك خقيت بنت جديده",
  "منور طالع حلو ع صوره جديده",
  "ها يولد ليش غيرت صورتك😍😂",
  "صوره جديده هنوه 😹😹🌚",
  "ها ياحب منين سرقت الافتار الجديد اعترف؟😹🌞",
  "ليش غيرت الصوره شسالفه ؟؟ 🤔🌞",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."RIKOR:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://RIKOR.ml/apiRIKOR/RIKOR.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @RIKORTEAM .')
return false 
end
Text = "ᎦᎾᏌᎡᏟᎬ ᎡＩᏦỎᎡ\n\n[⌯ ᎦᎾᏌᎡᏟᎬ ᎡᏆᏦỎᎡ](http://t.me/RIKORTEAM)\n\n[⌯ ᏆＮＦᎾ ᏚᎾᏌᎡᏟᎬ](http://t.me/lll_n_lll1)\n\n[⌯  ᎡᎬᏦᎾᎡ ᎠᎬᏙ](http://t.me/DEVRIKOR)\n\n[⌯  ᏴᎾᎢ ᎡᏆᏦᎾᎡ](http://t.me/AREEG_bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ᎦᎾᏌᎡᏟᎬ ᎡＩᏦỎᎡ',url="t.me/RIKORTEAM/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/RIKORTEAM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevRIKORW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*⌯︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'lll_n_lll1')..') \n*⌯︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'lll_n_lll1')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ boss
if text == 'تحديث' and DevRIKORW(msg) then
dofile('RIKOR.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevRIKORW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevRIKORW(msg) then  
function start_function(extra, result, success)
if RIKORSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevRIKORW(msg) then  
...
if RIKORSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مبرمج السورس او مطور الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevRIKORW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if RIKORSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مبرمج السورس او مطور الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevRIKORW(msg) then  
function start_function(extra, result, success)
if RIKORSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مبرمج السورس او مطور الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevRIKORW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevRIKORW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if RIKORSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مبرمج السورس او مطور الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevRIKORW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevRIKORW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevRIKORW(msg) then  
...
------------------------------------------------------------------------ boss
if text == ("مسح المطورين") and DevRIKORW(msg) then
...
if database:get(bot_id.."DEVRIKOR:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'DEVRIKOR:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevRIKORW(msg) then
t = ' *⌯︙ملفات السورس ريكور ↓*\n*┄─━━━ ᎡᎬ ━━━━─┄* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevRIKORW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/RIKORTEAM/Files_RIKOR/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات ريكور*\n*⌯︙ملفات السورس ↓*\n*┄─━━━ ᎡᎬ ━━━━─┄*\n\n"
local TextE = "\n*┄─━━━ ᎡᎬ ━━━━─┄*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورس ريكور ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/lll_n_lll1) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevRIKORW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/RIKORTEAM/Files_RIKOR/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('RIKOR.lua')  
else
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس ريكور* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevRIKORW(msg) then
...
if text == "مسح الملفات" and DevRIKORW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevRIKORW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevRIKORW(msg) then  
function start_function(extra, result, success)
...
st = https.request('https://RIKOR.ml/Imagelnfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://RIKOR.ml/Imagelnfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
local UserName = (b.username_ or "lll_n_lll1")
...
function Function_RIKOR(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RIKOR, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_RIKOR, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
function start_function(extra, result, success)
if RIKORSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مبرمج السورس او المطور الاساسي*")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙اسم المستخدم »* '..userid..''
...
---------
if text == ("رفع زوجتي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *⌯︙تم تعطيل الرفع*') 
return false
end
...
local  statuss  = '\n*⌯︙تم رفع العضو زوجتي في الكروب* \n*⌯︙تعال حبي استلم/ي الخاتم*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل زوجتي")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Mote:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم تنزيل العضو زوجتي في الكروب*\n*⌯︙تعال حبي رجع الخاتم*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل المجانين' and Mod(msg) then
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *⌯︙تم مسح جميع المجانين*')
end
if text == ("تاك للمجانين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n *⌯︙قائمه مجانين الكروب* \n*┄─━━━ ᎡᎬ ━━━━─┄*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» المجانين [@"..username.."]\n"
else
t = t..""..k.."» المجانين `"..v.."`\n"
end
end
if #list == 0 then
t = " *⌯︙مع الاسف لا يوجد مجانين*"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع مجنون") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *⌯︙تم تعطيل الرفع*') 
return false
end
...
local  statuss  = '\n*⌯︙تم رفع العضــو مجنون في الكروب* \n*⌯︙تعال يامجنون اصرفو له كرتون مجان*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل مجنون")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم تنزيل العضــو مجنون من الكروب*\n*⌯︙تعال رجع الكرتون*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n*⌯︙تم رفع العضــو مزه في الكروب* \n*⌯︙تعال حبي مزه هبلي بوسه*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم تنزيل العضــو مزه من الكروب*\n*⌯︙تعال خذ بوستك المعفنه*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
------------------------------------------------------------------------ الزعيم محمد
if text == 'تنزيل الورعان' and Mod(msg) then
database:del(bot_id..'Sakl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *⌯︙تم تنزيل جميع الورعان من الكروب*')
end
if text == ("تاك للورعان") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n *⌯︙قائمة ورعان الكروب* \n*┄─━━━ ᎡᎬ ━━━━─┄*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الورعان [@"..username.."]\n"
else
t = t..""..k.."» الورعان `"..v.."`\n"
end
end
...
---------
if text == ("رفع ورع") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *⌯︙تم تعطيل الرفع*') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
local  statuss  = '\n*⌯︙تم رفع المتهم ورع بالكروب*\n*⌯︙الان اصبح ورع الكروب*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل ورع")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Sakl:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم تنزيل العضو ورع*\n*⌯︙امشي على بيتكم يادادي*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *⌯︙تم تنزيل جميع كلاب الكروب*')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
local  statuss  = '\n*⌯︙تم رفع كلب في الكروب*\n*⌯︙تعال اربطوه باب القروب*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *⌯︙تم تنزيل جميع القرود بالكروب*')
end
...
------------------------------------------------------------------------ الزعيم محمد
if text == 'تنزيل الاطفال' and Mod(msg) then
database:del(bot_id..'Hors:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' *⌯︙تم تنزيل جميع الاطفال بالكروب*')
end
if text == ("تاك للاطفال") and Mod(msg) then
local list = database:smembers(bot_id..'Hors:User'..msg.chat_id_)
t = "\n *⌯︙قائمة اطفال الكروب \n*┄─━━━ ᎡᎬ ━━━━─┄*\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» *الاطفال* [@"..username.."]\n"
else
t = t..""..k.."» *الاطفال* `"..v.."`\n"
end
end
...
------------------------------------------------------------------------ الزعيم محمد
if text == ("رفع طفل") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *⌯︙تم تعطيل الرفع*') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
local  statuss  = '\n*⌯︙تم رفع طفل في الكروب*\n*⌯︙تعال حبي خذ البز تبعك*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل طفل")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Hors:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم تنزيل طفل من الكروب*\n*⌯︙رجع البز ياكبيرنا*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' *⌯︙تم تنزيل جميع البقر بالكروب*')
end
...
send(msg.chat_id_, msg.id_, ' *⌯︙تم تنزيل جميع الخرفان بالكروب')
end
...
send(msg.chat_id_, msg.id_, ' *⌯︙تم تنزيل جميع النفسيات*')
end
...
---------
if text == ("رفع نفسيه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) and GetChannelMember(msg) then  
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' *⌯︙تم تعطيل الرفع*') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
local  statuss  = '\n*⌯︙تم رفع نفسيه في الكروب*\n*⌯︙تعال يابني لتصير نفسيه تونس*'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل نفسيه")) and msg.reply_to_message_id_ and Mod(msg) and GetChannelMember(msg) then  
function start_function(extra, result, success)
database:srem(bot_id..'Jred:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
status  = '\n*⌯︙تم تنزيل نفسيه من الكروب*\n*⌯︙حلو كذا صار اليف*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RIKOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RIKOR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RIKOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RIKOR1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RIKOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RIKOR1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RIKOR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RIKOR1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RIKOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RIKOR1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RIKOR1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevRIKORW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevRIKORW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'lll_n_lll1')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevRIKORW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevRIKORW(msg) then  
...
if not database:get(bot_id..'DEVRIKOR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'DEVRIKOR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ريكور').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ريكور')
local RIKOR_Msg = {
'حبيب قلبي امرني 🥺💕.',
'هاا حبيبي شتريد ☹️.',
'شبيك لبيك 😂.',
'قول حبيبي ؟ انا اسمي '..Namebot..'',
'مشغول حالياً',
'عمري فداك '..Namebot..' قول حب'
}
send(msg.chat_id_, msg.id_,'['..RIKOR_Msg[math.random(#RIKOR_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevRIKORW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,RIKOR)
local t = "\n*ツ قائمة الاعضاء* \n*┄─━━━ ᎡᎬ ━━━━─┄*\n"
x = 0
local list = RIKOR.members_
for k, v in pairs(list) do
x = x + 1
...
if RIKORSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevRIKORW(msg) then 
...
if text == ("ردود المطور") and DevRIKORW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*┄─━━━ ᎡᎬ ━━━━─┄*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevRIKORW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevRIKORW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ريكور').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevRIKORW(msg) then   
...
if text == 'تعطيل المغادره' and DevRIKORW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RIKORTEAM')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'lll_n_lll1')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,' *⌯︙انت دخلت عبر الرابط لاتتعذر*') 
end
end,nil)
else
...
[[
☁️ . USERNAME . #username 🇾🇪 ꙰ 
☁️ . STAST . #stast 🇾🇪 ꙰ 
☁️ . ID . #id 🇾🇪 ꙰ 
☁️ . MSGS . #msgs 🇾🇪 ꙰ 
☁️ . ᏟᎻ ᎦᎾᏌᎡᏟᎬ . @CH_RIKOR 
]],
[[
- 𓏬 𝐔𝐬𝐄𝐫 : #username 𓂅 .
- 𓏬 𝐌𝐬𝐆  : #msgs 𓂅 .
...
-- vardump(data) 
RIKORdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevRIKORW(msg) then
...
{{text = '⓽', callback_data="/help9"},{text = 'اوامر الاعضاء', callback_data="/help10"}},
{{text = 'ᎦᎾᏌᎡᏟᎬ ᎡᏆᏦỎᎡ', url="t.me/RIKORTEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = 'ᎦᎾᏌᎡᏟᎬ ᎡᏆᏦỎᎡ', url="t.me/RIKORTEAM"}},
{{text = 'مطور السورس', url="t.me/DEVRIKOR"}},
}
...
zh = https.request('https://RIKOR.ml/amirZhfa/RIKOR.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*┄─━━━ ᎡᎬ ━━━━─┄*ٴ⌯∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*┄─━━━ ᎡᎬ ━━━━─┄*ٴ⌯∫○ٴ\n⌯︙[ᎦᎾᏌᎡᏟᎬ ᎡᏆᏦỎᎡ](t.me/lll_n_lll1) ')
end
...
gk = https.request('https://RIKOR.ml/amirBrg/RIKOR.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://RIKOR.ml/amirOmr/RIKOR.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://RIKOR.ml/amirVois/RIKOR.php')
if res == 200 then
...
if text == "ايش رئيك بهاذا" or text == "رئيك بهاذا" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"قليل ادب مجلس بنات ??🥺","حبيب البي اخلاقي ذا 😶","نفسيه ارجموه في اقرب مصحه😾😹","مطنوخ وراسه يابس","حق مزز😹💔","شوتري حق سمرات🙂😭","طايش مجنون زوجوه يعقل"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "ايش‌ رئيك بهاذه" or text == "رئيك بهاذه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"بنت اصول😻💗","طايشه متذربه اتركها ☹️😾","حقيره ومنتكبره 😶😂","بنت اصول😻💗","متذربه ماتصالح مع حد😒💔","مزه خلقه احببها🥺💗"," زوجوها تعقل😭💔"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "هينه" or text == "خبلا" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ياهو لاتذرب‌‌ لنعثك واهينك","ميستاهل اتعب روحي معه لانه عار","يابني قمذلف لاتهتان انت"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "مصه" or text == "بوسه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","انقلع مانت حلو😑","خدك/ك نضيف 😂","البوسه بالف ياحب 🌝💋","مابوس بالخد قرب فمك💋💓","كل شويه ابوسه بس 😏","امممممححححح كافيه🤤😻","مابوس خرفان قمنقلع 🇾🇪 ꙰ "}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "كت تويت" or text == "كت" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"آخر مرة زرت مدينة صنعاء؟!","آخر مرة أكلت أكلتك المفضّلة؟","الوضع الحالي؟\n‏1. سهران\n‏2. ضايق\n‏3. أتأمل","نسبه حبك للمالك من %100","اخر مره بكيت وش السبب","آخر شيء ضاع منك؟","كلمة أخيرة لشاغل البال؟","طريقتك المعتادة في التخلّص من الطاقة السلبية؟","شهر من أشهر العام له ذكرى جميلة معك؟","كلمة غريبة من لهجتك ومعناها؟🤓","‏- شيء سمعته عالق في ذهنك هاليومين؟","وش اسم امك","متى تكره الشخص الذي أمامك حتى لو كنت مِن أشد معجبينه؟","‏- أبرز صفة حسنة في صديقك المقرب؟","هل تشعر أن هنالك مَن يُحبك؟","اذا اكتشفت أن أعز أصدقائك يضمر لك السوء، موقفك الصريح؟","أجمل شيء حصل معك خلال هاليوم؟","صِف شعورك وأنت تُحب شخص يُحب غيرك؟👀💔","كلمة لشخص غالي اشتقت إليه؟💕","آخر خبر سعيد، متى وصلك؟","أنا آسف على ....؟","أوصف نفسك بكلمة؟","صريح، مشتاق؟","ارسل صورتك بدون فلتر"‏- صريح، هل سبق وخذلت أحدهم ولو عن غير قصد؟","‏- ماذا ستختار من الكلمات لتعبر لنا عن حياتك التي عشتها الى الآن؟💭","‏- فنان/ة تود لو يدعوكَ على مائدة عشاء؟😁❤","‏- تخيّل شيء قد يحدث في المستقبل؟","‏- للشباب | آخر مرة وصلك غزل من فتاة؟🌚","شخص أو صاحب عوضك ونساك مُر الحياة ما اسمه ؟","اذا شفت حد واعجبك وعندك الجرأه انك تروح وتتعرف عليه ، مقدمة الحديث شو راح تكون ؟."," فنانك المُفضل؟","لو خيروك تصاحب الناس الاذكياء او الناس المرحين","اسم معلم ترك اثراً جميل عليك رغم قسوتة.؟","وش الحب بنظرك؟","لو خيروك جاي او قهوه","لو فزعت/ي لصديق/ه وقالك مالك دخل وش بتسوي/ين؟","شاركنا أقوى بيت شِعر من تأليفك؟","نصيحه تبدا ب -لا- ؟","كل شيء يهون الا ؟","عندك الشخص الي مستعد يوقف ضد العالم عشانك.؟","العلاقة السرية دائماً تكون حلوة؟","منشن شخص واعترف له بشي","منشن لصديقك المُقرب؟.","اخر خيانه؟.","أول حرف من اسم الحب؟","تشارك كل شي لاهلك ولا فيه أشياء ما تتشارك؟","أكثر شيء تغيّر في أسلوب حياتك بعد كورونا ؟","هات شعورك بسطر اغُنيه؟","شيء مهما حطيت فيه مصاري بتكون مبسوط؟","اغرب شي سويته ؟","كيف تشوف الجيل هذا؟","اخر همك في الحياة ؟","انت من الناس الكتومة ولا تفضفض؟","اكثر مكان تروحه لحالك ؟","قوة الصداقة بشو بتتكون؟","تطبيق تبي تحذفه من جهازك بس مضطر تستخدمه ؟","كم أعلى مبلغ جمعته؟","اخر شي شريته ؟","كلمة للشخص اللي يسب ويسكر؟","لعبة بجوالك تلعبها دايم ؟","مر عليك موقف محرج؟","علمنا عن تجربه خلت شخصيتك اقوى ؟","يوم من أيام الأسبوع روتينه ممل عندك ؟","عندك شخص تسميه ثالث والديك؟","شو هو طعامك المفضل؟","اخر همك في الحياة ؟","شو حابب تقول للاشخاص اللي بتدخل حياتك؟","عبر عن حبك او كرهك لشخص ما تقدر توصل له مشاعرك","موهبتك المكبوتة ؟","انت من الناس اللي تتغزل بالكل ولا بالشخص اللي تحبه بس؟","عبر عن حبك او كرهك لشخص ما تقدر توصل له مشاعرك","ماذا يعني لك حرف A","ماذا يعني لك حرحرM","نسبة رضاك عن نفسك من 10 ؟","عندكم شخص بالبيت بصلح اي شي بيخرب؟","تحس نفسك هطف ؟","تدوس على قلبك او كرامتك؟","  تحس حياتك فاشله ولا ناجحه؟","لو الشخص اللي تحبه قال بدخل حساباتك بتعطيه ولا بترفض؟","ميزة وعيب فيك ؟","وش ينادونك في البيت ؟", }  
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "جرائه" or text == "جرائة" then
if not database:get(bot_id.. lock:add ..msg.chat_id_) then
local texting = {"روح/ي لشخص غريب وسبه وصور الشاشه وتعال","صور نفسك الان وارسلها","اختار شي من من الثلاث ونفذه\n‏1. احظر حبك وصورلنا\n‏2. سجل صوتك\n‏3. صور الي حولك.","","ازعج شخص بمية رساله وصولنا😽💗","روح قعقع دبات الغاز وسجل","روح اطلب من ابوك يزوجك وسجل","روح انشر بثلاث قروبات انا سالب ابي بنت نتونس🤣💔","غير افتارك حداد لمده خمس دقايق","غير اسمك الخطابه ام احمد","‏- ","وش اسم امك","غير نبذتك انا العاشق الولهان انا المغرم العشقان","‏- سجل الان صوتك وطلع شعر من راسك","العن شخص تحبه بالقروب ومنشنه","اضرط وسجل🤣💔","صور منطقتك من الطاقه الان","سجل‌‌ لقد شقشق الشوق شوقي فشاق شوقي لك فهل شقشق الشوق شوقك كشوق شوقي لشوقك وان شقشق الشوق شوقك كشوق شوقي لشوقك ، فشوقي اشق شوقا من شوقك سجلها صوت",}  
send(msg.chat_id_, msg.id_,   ..texting[math.random(#texting)]..  )
end
end
...
⌯├ الغاء كتم + حظر + تقيد ➾ بالرد : بالمعرف : بالايدي
⌯├ تقيد ~ كتم + الرقم + ساعه
⌯├ تقيد ~ كتم + الرقم + يوم
...
⌯├ مصه ➾ بالرد
⌯├ هينه ➾ بالرد
⌯├ ايش رئيك بهاذا ➾ بالرد
⌯├ ايش رئيك بهاذه ➾ بالرد
⌯├ تحب هذا ➾ بالرد
ٴ┄─━━━ ᎡᎬ ━━━━─┄
[⍆ ᎦᎾᏌᎡᏟᎬ ᎡᏆᏦỎᎡ](t.me/RIKORTEAM)
]]
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/RIKORTEAM'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ريكور')
if not database:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
if text ==  ""..Name_Bot..' ايش رئيك بهاذا' and tonumber(msg.reply_to_message_id_) > 0 then 
function FunBot(extra, result, success) 
local Fun = {'مضبح يمغص البطور',' ولد و ورده 💋🙄','يلعب ع البنات 🙄', 'ولد مخق البنات 😶🙊','ياليل ام الورعنه مخترت الا ذا ','ذا محترم بعد حاله️','اموت عليه 🌝','هو غير الحب حقي 🤓❤️','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' } 
...
function FunBot(extra, result, success) 
local Fun = {'الكبد مال اني ','يولي ماحبه ',' لٱ ايع ','بس لو الكفها اله اعضها 💔','ماخب زوجات اسف','اكلك ۿذﭑ يكلي احبكك لولا ﭑݩٺ شتكول  ','ئووووووووف اموت ع ربه ','ايععععععععع','بلعباس اعشكك','ماحب مخابيل','احبب ميدو وبس','لٱ ماحبه','بله هاي جهره تكلي تحبهه ؟ ','بربك ئنته والله فارغ وبطران وماعدك شي تسوي جاي تسئلني احبهم لولا','افبس حبيبي هذا' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
...
RIKOR = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RIKOR)
...
--------------------------------------------------------------------------------------------------------------
SourceRIKOR(data.message_,data)
...
------------------------------------------------------------------------
local RIKORAbot = database:get(bot_id.."RIKOR1:Add:Filter:Rp2"..text..result.chat_id_)   
if RIKORAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..RIKORAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RIKOR1_Msg = database:get(bot_id.."RIKOR1:Add:Filter:Rp2"..text..result.chat_id_)   
if RIKOR1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..RIKOR1_Msg)
